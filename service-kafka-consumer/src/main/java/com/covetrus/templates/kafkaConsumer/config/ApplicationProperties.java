package com.covetrus.templates.kafkaConsumer.config;
...
public class ApplicationProperties {
    @Getter private final KafkaConsumer kafkaConsumer = new KafkaConsumer();
    @Getter private final Logging logging = new Logging();

    public static class KafkaConsumer {
        @Getter @Setter private String topicName = "<not-specified>";
        @Getter @Setter private boolean listenerEnabled = true;
